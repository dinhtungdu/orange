...
orange task show <task_id>          # Show task details, TASK.md content, and history
orange task complete <task_id>      # Set status to reviewing (agent use)
orange task stuck <task_id>         # Set status to stuck (agent use)
